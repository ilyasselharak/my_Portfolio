      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-indigo-200 text-lg sm:text-xl leading-relaxed">
            I&apos;m a self-taught web developer with a deep passion for
            creating exceptional web experiences and crafting beautiful,
            functional websites and software. With a strong foundation in
            front-end and back-end development, I thrive on bringing innovative
            ideas to life and tackling complex challenges.
            <br />
            <br />
            ...
            trends. Whether it&apos;s mastering the latest technologies,
